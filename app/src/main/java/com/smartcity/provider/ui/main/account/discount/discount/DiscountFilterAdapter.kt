...
import kotlinx.android.synthetic.main.layout_discount_filter_item.view.*
...
class DiscountFilterAdapter (
    ...
    internal inner class CategoryValuesRecyclerChangeCallback(
        private val adapter: DiscountFilterAdapter
    ) : ListUpdateCallback {
    ...
    override fun onCreateViewHolder(
        ...
        return ValueHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.layout_discount_filter_item, parent, false),
    ...
    class ValueHolder(
        ...
        fun bind(item: String, position: Int,selectedCategoriesValue:String) = with(itemView) {
            ...
            if(item == selectedCategoriesValue){
                itemView.category_value_container.background= ResourcesCompat.getDrawable(resources,R.drawable.round_corner_bleu_light,null)
                itemView.category_value_name.setTextColor(ResourcesCompat.getColor(resources,R.color.bleu,null))
            }else{
                itemView.category_value_container.background= ResourcesCompat.getDrawable(resources,R.drawable.round_corner_grey,null)
                itemView.category_value_name.setTextColor(ResourcesCompat.getColor(resources,R.color.dark,null))
            }
